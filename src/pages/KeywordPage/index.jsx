      ...
      <div className="summary-tool">
        <header className="header">
          ...
          <Paragraph className="header_paragraph">
            Công cụ trích xuất từ khóa là giải pháp tối ưu giúp bạn nhanh chóng
            nhận diện các từ khóa quan trọng từ văn bản nhập tay hoặc từ các tệp
            Word được tải lên.
          </Paragraph>
          <Paragraph className="header_paragraph">
            Bằng cách sử dụng các thuật toán xử lý ngôn ngữ tự nhiên tiên tiến,
            công cụ sẽ phân tích nội dung, xác định các thuật ngữ, ý chính nổi
            bật, và sắp xếp chúng một cách rõ ràng, dễ hiểu.
          </Paragraph>
        </header>
        <Form form={form} layout="vertical" onFinish={handleSummarize}>
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Vui lòng nhập nội dung cần trích xuất từ khóa!",
              },
            ]}
          >
            <TextArea
